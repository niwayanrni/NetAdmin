...
return (
    ...
    {/* Header */}
        <div className="relative">
            <img
                src="/src/assets/IsiTourPackage/Gambar7.jpg"
                alt="Uluwatu Temple"
    ...
    {/* Konten dibawah Header */}
        <div className="ml-0 md:ml-[-60px]">
            <p className="text-gray-600 font-semibold text-lg mt-5">Badung, Bali</p>
                <h2 className="text-2xl font-bold mt-1 mb-4">Uluwatu Temple</h2>
                <h3 className="text-base font-bold mt-0 mb-0">Description</h3>
            <p className="mt-1 text-gray-700 text-justify text-base">
                Uluwatu Temple, or Pura Luhur Uluwatu, is one of Bali’s most significant sea temples,
                located atop a steep cliff about 70 meters above the Indian Ocean in Pecatu, South Kuta.
                This iconic temple is not only a place of worship but also a site of extraordinary
                natural beauty, famous for its dramatic sunset views and cultural performances.

                Perched on a limestone cliff, the temple offers breathtaking views of
                the vast ocean below and is believed to protect Bali from evil sea spirits.

                A must-see cultural experience, the traditional Kecak dance is
                performed daily during sunset, narrating the story of the Ramayana epic.

                The temple area is home to many macaques, which are believed to
                guard the temple but are also known for their cheeky behavior.

                Uluwatu Temple is a popular spot for sunset viewing, with the
                golden hues of the sky beautifully blending with the ocean.
            </p>
...
export default IsiTourPackage2;
