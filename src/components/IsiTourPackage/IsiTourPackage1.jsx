...
return (
    ...
    {/* Header */}
        <div className="relative">
            <img
                src="/src/assets/IsiTourPackage/Gambar6.jpg"
    ...
    {/* Konten dibawah Header */}
        <div className="ml-0 md:ml-[-60px]">
            <p className="text-gray-600 font-semibold text-lg mt-5">Tabanan, Bali</p>
                <h2 className="text-2xl font-bold mt-1 mb-4">Luhur Tanah Lot Temple</h2>
                <h3 className="text-base font-bold mt-0 mb-0">Description</h3>
            <p className="mt-1 text-gray-700 text-justify text-base">
                Tanah Lot Temple is one of Bali’s most iconic landmarks, located in Beraban Village,
                Kediri District, Tabanan Regency. This sea temple is perched on a large rock
                formation along the coastline, offering breathtaking views and deep spiritual
                significance. It is a major Hindu pilgrimage site and a popular spot for
                witnessing spectacular sunsets.

                Built on a rocky outcrop separated from the mainland during high tide,
                visitors can walk closer to the temple during low tide.

                Tanah Lot is renowned as one of the best places to enjoy sunset views,
                with the temple silhouette creating a dramatic scene.

                The temple was established by Dang Hyang Nirartha, a Hindu priest,
                and is believed to be dedicated to the sea gods.

                A natural freshwater spring near the temple is considered sacred
                and is used for blessings and rituals by devotees.
            </p>
