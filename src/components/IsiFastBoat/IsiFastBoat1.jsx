    ...
    return (
        <div className="bg-[#EEEEEE]">
            ...
            <div className="relative">
                <img
                    src="/src/assets/IsiFastbout/Gambar1.jpg"
                    alt="FastBoat1"
            ...
            <div className="max-w-5xl mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="ml-0 md:ml-[-60px]">
                    <p className="text-gray-600 font-semibold text-lg mt-5">Jembarana, Bali</p>
                    ...
                    <p className="mt-1 text-gray-700 text-justify text-base">
                        Gilimanuk is a coastal town located in western Bali, known as the main gateway between
                        Bali and Java. This port town serves as the departure point for ferries connecting Bali
                        to Banyuwangi, making it an important transit hub for travelers.

                        Beyond its role as a transportation center, Gilimanuk offers natural beauty with its
                        coastal scenery and calm waters, making it a great place to explore before or after
                        crossing the strait.

                        The area is famous for its seafood, with local restaurants serving delicious
                        grilled fish and other fresh catches from the sea.

                        Gilimanuk is also rich in history, with archaeological discoveries indicating
                        ancient human settlements in the region, adding cultural significance to the town.

                        Visitors can enjoy the peaceful atmosphere and explore nearby natural attractions,
                        making Gilimanuk more than just a transit point.
                    </p>
                    ...
                    <div className="flex flex-col md:flex-row justify-between mt-4">
                        <div className="w-full md:w-1/2">
                            ...
                            <ul className="list-disc pl-6 text-gray-700 text-base">
                                <li>West Bali National Park</li>
                                <li>Menjangan Island</li>
                                <li>Karang Sewu Beach</li>
                            </ul>
                        </div>
