...
return (
    ...
    <section className="py-16 px-6 md:px-16">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden group scale-90">
                <img src="/src/assets/Bali Activities/Gambar5.jpg" alt="Jeep sunrise tour" className="w-full h-48 object-cover" />
            <div className="p-4">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden group scale-90">
                <img src="/src/assets/Bali Activities/Gambar6.jpg" alt="snorkeling" className="w-full h-48 object-cover" />
            <div className="p-4">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden group scale-90">
                <img src="/src/assets/Bali Activities/Gambar7.jpg" alt="Bali Swing" className="w-full h-48 object-cover"/>
            <div className="p-4">
                <p className="text-sm text-left font-light text-gray-600">Klungkung, Bali</p>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden group scale-90">
                <img src="/src/assets/Bali Activities/Gambar8.jpg" alt="Rafting Ubud" className="w-full h-48 object-cover" />
            <div className="p-4">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden group scale-90">
                <img src="/src/assets/Bali Activities/Gambar9.jpg" alt="Batur Sunrise Trekking" className="w-full h-48 object-cover" />
            <div className="p-4">
                <p className="text-sm text-left font-light text-gray-600">Bangli, Bali</p>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden group scale-90">
                <img src="/src/assets/Bali Activities/Gambar10.jpg" alt="waterboom bali" className="w-full h-48 object-cover" />
            <div className="p-4">
                <p className="text-sm text-left font-light text-gray-600">Karangasem, Bali</p>
